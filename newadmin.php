...
$q="insert into new_admin(aname,apss,acpass) values ('$aname','$apass','$acpass')";
 ...
 if($q1)	  
	   ...
	   {
      echo "<script>alert(' Error in creating new admin ')</script>";
	   }
...
<div class="container-fluid">
  ...
  <form method="POST">
       ...
       <input type="text" placeholder="Enter new admin Name" name="aname">  <br>
